...
[Task, Tsync, ks, metrics, stats, centroids_good ] = import_pacman_data(subject,date, 'gNum', gNum,'tNum', tNum, 'imecNums', imecNums,...
    'channelMapFile', channelMapFile, ...
    'padDuration', padDuration, 'saveTags', saveTags, ...
    'syncChan', syncChan, 'syncBit', syncBit, ...
    'loadMetrics',true, ...
