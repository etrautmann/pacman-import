...
function syncDat = extractSyncChannelFromFile(filename, nChanTotal, syncChanIndex)
...
for b = 1:nBatch
    dat = fread(fid, [1, maxReadSize], 'int16=>int16', (nChanTotal-1)*2); % skipping other channels
...
dat = fread(fid, [1, Inf], 'int16=>int16', (nChanTotal-1)*2); % skipping other channels
fwrite(fidOut, dat, 'int16');
if nargout>0
